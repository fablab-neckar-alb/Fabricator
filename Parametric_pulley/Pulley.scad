...
module Pulley(
  ...
  belt_type = (profile == 1) ? "MXL"
            ...
            : (profile == 14) ? "GT2 5mm"
            : -1;
  pulley_OD = (profile == 1) ? MXL_pulley_dia
            : (profile == 2) ? 40DP_pulley_dia
            : (profile == 3) ? XL_pulley_dia
            : (profile == 4) ? H_pulley_dia
            : (profile == 5) ? T2_5_pulley_dia
            : (profile == 6) ? T5_pulley_dia
            : (profile == 7) ? T10_pulley_dia
            : (profile == 8) ? AT5_pulley_dia
            : (profile == 9) ? HTD_3mm_pulley_dia
            : (profile == 10) ? HTD_5mm_pulley_dia
            : (profile == 11) ? HTD_8mm_pulley_dia
            : (profile == 12) ? GT2_2mm_pulley_dia
            : (profile == 13) ? GT2_3mm_pulley_dia
            : (profile == 14) ? GT2_5mm_pulley_dia
            : -1;
  tooth_depth = (profile == 1) ? 0.508
              : (profile == 2) ? 0.457
              : (profile == 3) ? 1.27
              : (profile == 4) ? 1.905
              : (profile == 5) ? 0.7
	...
	difference()
	 {	 
		...
		difference()
			...
			if ( profile == 8 ) { AT5pulley_t_ht=pulley_t_ht();}
		...
		if ( pulley_b_ht < m3_nut_flats ) { if (no_of_nuts > 0) echo ("CAN'T DRAW CAPTIVE NUTS, HEIGHT LESS THAN NUT DIAMETER!!!"); } else {
		if ( (pulley_b_dia - motor_shaft)/2 < m3_nut_depth + 3 ) { if (no_of_nuts > 0) echo ("CAN'T DRAW CAPTIVE NUTS, DIAMETER TOO SMALL FOR NUT DEPTH!!!"); } else {
